...
- [ ] **App-aware dictation**: detect target app (WhatsApp vs Slack vs Cursor/IDE etc.) and apply per-app settings, cleanup, formatting; profiles editable; research how to detect target app.
...
## Future
- [ ] Syncing server
- [ ] Sync with external services (e.g. Google, Outlook) for tasks, notes, reminders
- [ ] Talk and talk back (e.g. agent / LiveKit style): chat with AI that can see your screen — “rubber duck” use case
